...
Om vi nu använder \miniCode{optimise( f 1 2 )}, så är \miniCode{z} okänd, men i
grenarna finns det \kw{case}-sastser som bara beror på \miniCode{x} och \miniCode{y} 
och rätt gren kan alltså väljas. Vi har stöd för att optimera i sådana här \kw{case}-grenar:
...
Om vi här försöker optimera i brancherna då \ic{z} är okänd kommer optimeringen
