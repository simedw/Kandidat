...
Här är det möjligt att genom att ge keywordet `\kw{with}' efter optimise ge olika options.
...
grenarna så finns det case-sastser som bara beror på \miniCode{x} och \miniCode{y} 
