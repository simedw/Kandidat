...
de definerades och och inte där de användes (om de användes), vilket kunde leda
...
\label{CBN:FunK}\CBNOMEGA s{\heap f{\FUN{\overline{xs}}{e}}}A{f \, \overline{as}} \Rightarrow & \CBNMC {f \, \overline{as}}sHA \\
 & \overline{as} \text{ kända } \nonumber \\
\label{CBN:FunI}\CBNOMEGA s{\heap f{\FUN{\overline{xs}}e}}A{f\, \overline{as}} \Rightarrow & \CBNOMEGA sHA{\text{infoga } f \text{ med } \overline{as}} \\
 & \text{ samma antal atomer i } \overline{xs} \text{ som i } \overline{as} \nonumber
\end{align}
