...
\ic{B}-grenen. Sedan under körningstid behöver man kolla på x en gång för att sedan avgöra vilken av de optimerade grenarna man ska använda.
...
\begin{itemize}
    \item Kan ta väldigt långt tid. Tänk dig \ic{power} funktionen men en specialversion för varje heltal som finns. (Naturligtvis hade man använt någon mekanism för att annotera vad som ska specialiseras och inte)
...
Att översätt optimise till att arbete med en anropsstack var relativt svårt. Varje gång en funktion infogades, eller någon \kw{let} kunde tas bort behövde alla efterkommande indexes räknas om. 
