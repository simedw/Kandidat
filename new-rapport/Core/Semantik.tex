...
det så att \miniCode{x} pekar på det nya värdet och om \miniCode{x}'s värde skulle behövas
...
\begin{enumerate}
\item Om \miniCode{x} beror på sig själv, eller flera variabler beror på varandra, utan
