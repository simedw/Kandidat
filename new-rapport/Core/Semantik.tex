...
vad vi skall sätta in variabler i. Så här är \ic{map} definerad:
...
Nu skall a bindas till ett uttryck, \miniCode{cube 2}. I ett tradionellt imperativt språk skulle
