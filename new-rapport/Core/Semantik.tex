...
Anledningen till att en ny variabel \ic{v} skapas är för att förhindra namnkrockar på heapen. Namnkrockar kan annars ske när koden körs flera gånger (den kan vara rekursiv eller anropas av andra funktioner fler gånger). 
