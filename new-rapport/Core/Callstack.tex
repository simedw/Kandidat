...
används utanför \obj{THUNK}-objekten i \miniCode{map} inte gäller i thunkarna. Vi kommer därför att evaluera
...
måste \obj{THUNK}-en ha information om vilka lokala variabler i \miniCode{map} 
...
När variabler bundna till \kw{let}-thunkar allokeras, som \miniCode{<a,4>}
