...
\item  Det sista uttrycken, \kw{optimise ...}, tar ett uttryck som ska optimeras. Det finns även direktiv för hur optimeringen ska gå till, de går att läsa om i sektion \ref{sec:Optimise:With}.
...
Vilket innebär, i skillnad mot Haskell, att det inte går att byta plats på \kw{t1} och \kw{t2}.
